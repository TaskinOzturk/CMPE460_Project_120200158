...
# Attention!!! To run this file, Write this code in your terminal: streamlit run "path of your file"
...
st.write("Next 10 Days stock price:", last_val + next_val, np.concatenate((last_val, next_val), axis=0))
